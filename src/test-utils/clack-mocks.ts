...
export const mockConfirm = mock((): Promise<boolean | symbol> => Promise.resolve(false))
export const mockIsCancel = mock((value: unknown) => value === Symbol.for("clack:cancel"))
export const mockText = mock((): Promise<string | symbol> => Promise.resolve(""))
export const mockSelect = mock((): Promise<string | symbol> => Promise.resolve(""))
