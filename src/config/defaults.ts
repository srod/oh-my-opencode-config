 ...
 *
 * Source of Truth:
 * https://github.com/code-yeongyu/oh-my-opencode/blob/v3.10.0/src/shared/model-requirements.ts
 *
 * Last Updated: Mar 2026 (v3.10.0)
 */
export const DEFAULT_CONFIG: Config = {
  ...
  categories: {
    ...
    writing: { model: "google/kimi-k2.5-free" },
  },
}
